<div class="container conteneur_page">
    <div class="row">
      <div class="col l4 offset-l6 bloc_blanc z-depth-5">
          <h4 class="center-align">Mes projets</h4>
          <div class="row">
          <img class="responsive-img col l6 offset-l3" src="../img/logo_noisy.png" style=""></img>
          </div>
